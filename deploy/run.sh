...
docker run --rm -it -e ANTHROPIC_API_KEY=$ANTHROPIC_API_KEY -e OPENAI_API_KEY=$OPENAI_API_KEY -e MISTRAL_API_KEY=$MISTRAL_API_KEY -e AWS_ACCESS_KEY_ID=$AWS_ACCESS_KEY_ID -e AWS_SECRET_ACCESS_KEY=$AWS_SECRET_ACCESS_KEY -e ND_API_KEY=$ND_API_KEY -e GOOGLE_API_KEY=$GOOGLE_API_KEY -e TOGETHER_API_KEY=$TOGETHER_API_KEY -e COHERE_API_KEY=$COHERE_API_KEY -e DEBUG=true -v ${PWD}/debug:/usr/src/app/debug -v tt-logs:/var/log/tt --ulimit nofile=32768 ghcr.io/medusa-ml/translatetribune:latest